...
public class Address extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3075874868013815729L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Address\",\"namespace\":\"avro.schema\",\"fields\":[{\"name\":\"doorNo\",\"type\":[\"null\",\"string\"]},{\"name\":\"pinCode\",\"type\":[\"null\",\"string\"]},{\"name\":\"street\",\"type\":[\"null\",\"string\"]}]}");
   ...
   */
  public static avro.schema.Address.Builder newBuilder() {
    return new avro.schema.Address.Builder();
  }
   ...
   * @return A new Address RecordBuilder
   */
  public static avro.schema.Address.Builder newBuilder(avro.schema.Address.Builder other) {
    if (other == null) {
      return new avro.schema.Address.Builder();
    } else {
      return new avro.schema.Address.Builder(other);
    }
  }
   ...
   * @return A new Address RecordBuilder
   */
  public static avro.schema.Address.Builder newBuilder(avro.schema.Address other) {
    if (other == null) {
      return new avro.schema.Address.Builder();
    } else {
      return new avro.schema.Address.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Address>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(avro.schema.Address.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(avro.schema.Address other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.doorNo)) {
        this.doorNo = data().deepCopy(fields()[0].schema(), other.doorNo);
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.schema.Address.Builder setDoorNo(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.schema.Address.Builder clearDoorNo() {
      doorNo = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.schema.Address.Builder setPinCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.schema.Address.Builder clearPinCode() {
      pinCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.schema.Address.Builder setStreet(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.schema.Address.Builder clearStreet() {
      street = null;
